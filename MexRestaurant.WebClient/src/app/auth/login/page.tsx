...
import { handleLoginContext } from "@/services/AuthService";

export default function Login() {
  const { register, handleSubmit } = useForm();
  const router = useRouter()

  const handleLoginForm = ({ email, password }: any) => {
    handleLoginContext(email, password).then((result: ILoginRequest) => {
